...
public class VertexManager {
  ...
  class VertexManagerPluginContextImpl implements VertexManagerPluginContext, VertexStateUpdateListener {
    ...
    public boolean canReduceParallelism() {
      return false;   // do not use auto parallelism for Tez (unused for Tez)
    }

    @Override
    public boolean hasOneToOneOutputEdge() {
      return true;    // by default, do not use stats (unused for Tez)
    }
