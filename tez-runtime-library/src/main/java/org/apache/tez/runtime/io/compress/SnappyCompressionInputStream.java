...
/** Reader for Tez's provider-private Snappy block framing. */
final class SnappyCompressionInputStream extends BlockCompressionInputStream {
  ...
  SnappyCompressionInputStream(
      ...
      throws IOException {
    super(input, bufferSize, maxCompressedLength, SnappyCompressionOutputStream.MAGIC,
        "Snappy");
