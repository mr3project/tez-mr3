...
/** Reader for Tez's provider-private Zstd block framing. */
final class ZstdCompressionInputStream extends BlockCompressionInputStream {
  ...
  ZstdCompressionInputStream(
      ...
      throws IOException {
    super(input, bufferSize, maxCompressedLength, ZstdCompressionOutputStream.MAGIC, "Zstd");
