...
public final class Lz4CompressionProvider implements CompressionProvider {
  ...
  public Lz4CompressionProvider(int bufferSize, boolean useHighCompression, boolean useNativeInstance) {
    ...
    // LZ4Compressor instances are stateless. Share this one because decompression only needs the
    // maximum compressed length calculation, not a dedicated compressor for every decompressor.
