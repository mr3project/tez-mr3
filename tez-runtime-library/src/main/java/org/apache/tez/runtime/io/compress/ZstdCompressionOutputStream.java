...
/** Writer for Tez's provider-private Zstd block framing. */
final class ZstdCompressionOutputStream extends BlockCompressionOutputStream {
  ...
  ZstdCompressionOutputStream(
      ...
      throws IOException {
    super(output, compressor.ensureInputCapacity(validateBlockSize(bufferSize, "Zstd")),
        bufferSize, MAGIC, "Zstd");
