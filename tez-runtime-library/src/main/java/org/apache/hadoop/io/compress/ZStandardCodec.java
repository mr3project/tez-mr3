...
public class ZStandardCodec implements
  ...
  // false == unknown, true == loaded
  // no need to use volatile because it is set to true at most once per thread
  ...
  public static boolean isNativeCodeLoaded() {
    return isNativeCodeLoaded ||
      (ZStandardCompressor.isNativeCodeLoaded() && ZStandardDecompressor.isNativeCodeLoaded());
  }
